...
# MAGIC %md
# MAGIC # ✅ REFERENCE SOLUTION — 03b_agent_memory_dreaming
# MAGIC Completed version. In the attended session, work from workshop/03b_agent_memory_dreaming.py; use this to unblock.
# COMMAND ----------
# MAGIC %md
