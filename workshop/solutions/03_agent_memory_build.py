...
# MAGIC %md
# MAGIC # ✅ REFERENCE SOLUTION — 03_agent_memory_build
# MAGIC Completed version. In the attended session, work from workshop/03_agent_memory_build.py; use this to unblock.
# COMMAND ----------
# MAGIC %md
